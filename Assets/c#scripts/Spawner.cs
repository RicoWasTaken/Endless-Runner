...
{
    //Create a public array of platforms to spawn, we will fill this up in the unity editor.
    public GameObject[] objectsToSpawn;

    float timeToNextSpawn;    //Tracks how long we should wait before spawning a new object
    float timeSinceLastSpawn = 0.0f;    //Tracks the time we last spawned something
    ...
    void Start()
    {
        //Random.Range returns a random float between the 2 numbers
    ...
    void Update()
    {
        ...
        {
            //Use Random.Range to pick a number between 0 and the amount of items we need on our object list
